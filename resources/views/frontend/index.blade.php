        ...
        <div class="navbar-area">
            ...
            <div class="mobile-nav">
                <a href="index.html" class="logo">
                    <img src="{{ asset('/frontend/img/logo.png') }}" class="logo-one" alt="Logo">
                    <img src="{{ asset('/frontend/img/sticky-logo.png') }}" class="logo-two" alt="Logo">
                </a>
            </div>
                ...
                <div class="container">
                    <nav class="navbar navbar-expand-md navbar-light ">
                        ...
                        <a class="navbar-brand-sticky" href="index.html">
                            <img src="{{ asset('/frontend/img/sticky-logo.png') }}" alt="Logo">
                        </a>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="banner-img">
                            <img src="{{ asset('/frontend/img/home1.png') }}" alt="Banner Images">
                        </div>
                    </div>
